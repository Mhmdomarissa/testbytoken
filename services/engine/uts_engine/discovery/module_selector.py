...
from uts_engine.discovery.module_filter import parse_module_from_description, slugify_module as slugify
...
def resolve_selected_from_input(inp: dict, modules: list[dict[str, Any]]) -> list[str]:
    ...
    from uts_engine.discovery.module_filter import parse_module_from_description
