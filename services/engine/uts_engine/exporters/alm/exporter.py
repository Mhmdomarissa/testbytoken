...
from uts_engine.automation.base import TestResult
from uts_engine.discovery.discovery import DiscoveryResult, ScenarioDef
from uts_engine.workdir import data_root

# services/engine/, three levels above this file (uts_engine/exporters/alm/).
...
def export_discovery_to_alm(
    ...
    """
    cfg = load_alm_config()
    output_dir = data_root() / cfg.get("output_path", "alm-output")
