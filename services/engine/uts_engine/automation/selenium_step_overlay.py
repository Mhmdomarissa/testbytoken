...
from uts_engine.automation.selenium_session import get_driver, is_selenium_enabled, load_selenium_config
...
def _highlight_element(locator_key: str) -> None:
    ...
    try:
        ...
        from uts_engine.automation.selenium_actions import wait_visible
