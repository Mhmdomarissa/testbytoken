...
# services/engine/, two levels above this file (uts_engine/automation/).
ROOT = Path(__file__).resolve().parent.parent.parent
CONFIG_DIR = ROOT / "config"
LOGS_DIR = data_root() / "logs"
RESULTS_DIR = data_root() / "reports"
UTS_RESULTS = Path(os.environ.get("UTS_LEGACY_RESULTS", r"D:\uts\results"))
...
def run_step(
    ...
    *,
    ...
    try:
        from uts_engine.automation.selenium_session import is_selenium_enabled
        from uts_engine.automation.selenium_step_overlay import locator_key_for_object, show_result, show_step
    ...
    try:
        from uts_engine.automation.selenium_session import is_selenium_enabled
        from uts_engine.automation.selenium_step_overlay import show_result
