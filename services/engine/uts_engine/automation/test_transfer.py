...
from uts_engine.automation.base import ExecutionLogger, TestResult, load_test_data, run_step
from uts_engine.automation.selenium_actions import click, get_text, is_visible, select_by_visible_text, type_text
from uts_engine.automation.selenium_session import is_selenium_enabled
from uts_engine.automation.selenium_step_overlay import set_test_case
...
def _simulated_fallback(log, xfer, started):
    from uts_engine.automation.base import simulate_delay
