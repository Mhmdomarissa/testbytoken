...
class EngineHost:
    ...
    def warm(self) -> None:
        ...
        def _warm() -> None:
            try:
                from automation.selenium_session import warm_browser
    ...
    def login_handoff(self, job: str, url: str) -> str:
        ...
        from dynamic.discovery import _find_password, _find_username
    ...
    def scan(self, job: str, cmd: dict) -> None:
        from run_automation_only import scan_modules_to_json
    ...
    def inspect(self, job: str, cmd: dict) -> None:
        ...
        """
        from automation.selenium_session import get_driver, has_session, start_browser
        from dynamic.discovery import (
            _best_locator,
    ...
    def run(self, job: str, cmd: dict) -> None:
        from automation.selenium_session import has_session
        from run_automation_only import create_and_run
    ...
    def _run_job(self, name: str, job: str, cmd: dict) -> None:
        ...
        try:
            ...
            try:
                from automation.selenium_session import quit_driver
...
def main() -> int:
    ...
    try:
        ...
        try:
            from automation.selenium_session import shutdown_all
