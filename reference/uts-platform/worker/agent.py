...
def _run_job(job: dict, server: str, token: str) -> tuple[str, str, int]:
    from automation.selenium_session import set_browser, shutdown_all, start_browser
    from run_automation_only import create_and_run, scan_modules_to_json
    from webapp.job_control import JobStopped, clear_stop, is_stop_requested, request_stop
    ...
    try:
        ...
        if job_type == "PIPELINE":
            ...
            from dynamic.module_selector import modules_catalog_exists
