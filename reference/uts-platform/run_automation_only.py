...
from selenium_script_generator import generate_selenium_from_discovery
from dynamic.common_actions import save_actions_catalog
from alm.exporter import export_discovery_to_alm, export_modules_catalog_to_alm
...
def create_and_run(
    ...
    if use_ai:
        from dynamic.ai_pipeline import apply_ai_plan_to_discovery

        page_map_path = ROOT / "generated" / "page-map.json"
        page_map = {}
    ...
    selenium_dir = ROOT / "generated" / "selenium_automation"
