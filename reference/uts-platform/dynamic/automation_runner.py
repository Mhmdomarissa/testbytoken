...
from automation.selenium_session import get_driver, navigate
from automation.selenium_step_overlay import register_step_locator, set_dynamic_locators, set_test_case
from dynamic.common_actions import execute_workflow_action, infer_action_from_button, normalize_action, save_actions_catalog
from dynamic.discovery import AUTOMATION_TYPES, DiscoveryResult, ScenarioDef, StepDef
from dynamic.login_helpers import fill_username_and_trigger_role, wait_role_select_enabled
...
def run_scenario(
    ...
    if fresh_login_before:
        from automation.session_reset import perform_login_from_discovery
    ...
    for step in scenario.steps:
        try:
            from webapp.job_control import raise_if_stopped
...
def run_all_automation(
    ...
    from automation.session_reset import prepare_fresh_session, teardown_after_test
    ...
    for scenario in auto_scenarios:
        try:
            from webapp.job_control import JobStopped, raise_if_stopped
